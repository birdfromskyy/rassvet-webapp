...
- Единый визуальный стиль «Rassvet 2.0» с адаптивом под мобильные устройства
...
- Отзывы с модерацией (pending → approved / rejected), анонимный режим; просмотр доступен без авторизации
