...
const MODULE_TITLE = "Сотрудники";
const PUBLIC_PAGE_URL = "/employees";
...
const AdminTeachers = () => {
  ...
  const saveSubjects = async () => {
    try {
      ...
      toast.success("Предметы сотрудника обновлены");
      closeSubjects();
    } catch (e) {
      toast.error(e.response?.data?.error || "Ошибка сохранения");
    }
  ...
  const saveRooms = async () => {
    try {
      ...
      toast.success("Кабинеты сотрудника обновлены");
      closeRooms();
    } catch (e) {
      toast.error(e.response?.data?.error || "Ошибка сохранения");
    }
        ...
        <section className="admin-module__hero">
          <div>
            ...
            <p>
              ...
              образованием, рабочим временем и отображением специалистов на
              сайте.
            </p>
          </div>
          ...
          <DialogContent className="admin-module-dialog__content">
            <Box display="flex" flexDirection="column" gap={2} sx={{ mt: 1 }}>
              ...
              <TextField
                ...
                rows={3}
                placeholder={
                  "Московский педагогический университет, 2005\nКурсы повышения квалификации, 2020"
                }
              />
              ...
              <Box display="flex" gap={2} alignItems="center">
                <TextField
                  ...
                  onChange={(e) =>
                    setForm({ ...form, sort_order_cms: e.target.value })
                  }
                  sx={{ width: 220 }}
                  inputProps={{ min: 0 }}
                />
