...
beforeEach(() => { vi.resetAllMocks(); service.list.mockResolvedValue({ staff, reminder_times: { birthdays: '11:00', medical: '11:05' } }); service.recipients.mockResolvedValue([{ id: 7, profile_url: 'https://vk.com/id700', enabled: true, medical: false, birthdays: false, revision: 0 }]); });
