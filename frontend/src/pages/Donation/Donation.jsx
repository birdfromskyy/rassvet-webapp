      ...
      <main className="donation">
        <div className="page-container donation__container">
          ...
          <div className="donation__notice">
            ...
            предпринимателем, а не благотворительной или некоммерческой
            организацией. Перевод является добровольным взносом на поддержку
            деятельности центра и не признаётся пожертвованием в соответствии с
            законодательством РФ. Налоговый вычет не предусмотрен. Возврат
            добровольных взносов не производится.
          </div>
